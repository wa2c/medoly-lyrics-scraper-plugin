...
//    internal var cacheTitleEditText: EditText? = null
//    @BindView(R.id.cacheArtistEditText)
//    internal var cacheArtistEditText: EditText? = null
//    @BindView(R.id.cacheListView)
//    internal var cacheListView: ListView? = null
...
//    private var intentSearchArtist: String? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cacheListView.setOnItemClickListener { parent, view, position, id ->
            val item = cacheList[position]
        ...
        when (item.itemId) {
            ...
            R.id.menu_cache_delete -> {
                ...
                val dialog = ConfirmDialogFragment.newInstance(
                        ...
                        getString(R.string.label_dialog_cache_delete), null,
...
//    }
    ...
    //    @Background
    private fun searchCache(title: String, artist: String, album: String?) {
        try {
...
//    internal fun cacheListViewItemClick(position: Int) {
//        val item = cacheList[position]
//        val dialog = CacheDialogFragment.newInstance(item)
//        dialog.setClickListener { dialog, which ->
//            if (which == DialogInterface.BUTTON_POSITIVE) {
//                // Save
//                currentCacheItem = item
//                AppUtils.saveFile(this@CacheActivity, item.title, item.artist)
 ...
 */
internal class CacheAdapter(context: Context) : ArrayAdapter<SearchCache>(context, R.layout.layout_search_item) {
...
//        holder.albumTextView!!.text = context.getString(R.string.label_cache_item_album, AppUtils.coalesce(item.album))
    ...
    private class ListItemViewHolder {
        ...
        internal var albumTextView: TextView? = null
